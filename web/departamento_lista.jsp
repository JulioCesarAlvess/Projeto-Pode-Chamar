...
<html>
 ...
 <nav class="navbar navbar-default fixed">
        ...
        <div class="container">
            ...
            <form role="form" class="form-horizontal" action="ListarDepartamento" >
                ...
                <h2 class="titulo-formulario">Lista de Departamentos <a href="/podechamar_v1/departamento_gestao.jsp" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></a></h2>
                    ...
                    <table class="table table-hover table-condensed"  style="width: 500px;">
                        ...
                        <tbody>
                           <%
                            ...
                            <tr>
                               <td> <%= d.getDep_nome()%> </td>
                               <td> <%= d.getDep_status()%> </td>
                               
                                <td><a href="/podechamar_v1/AlterarDepartamento?btnOperacao=BUSCAR&id=<%= d.getId()%> " class="btn btn-default" > <i class="glyphicon glyphicon-pencil"></i></a> <td>
                                    <%
                                       if (!d.getDep_status().equals("Inativo")) {
                                    %>
                                <td><a href="/podechamar_v1/ListarDepartamento?btnOperacao=EXCLUIR&id=<%= d.getId()%> " class="btn btn-default" > Inativar</a> <td>
                                    <%
                                       }
                                    %>
                            </tr>
