...
<html>
    ...
    <body>
        ...
        <div class="container ">
            ...
            <form role="form" class="form-horizontal" action="SalvarDepartamento" method="post">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3" >
                        ...
                        <input type="text" class="form-control" name="dep_nome" placeholder="Nome do Departamento" />
                    </div>
                    <div class="col-md-6 mb-3" >
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="dep_descricao" placeholder="Descrição do Departamento" />
                        </div>
