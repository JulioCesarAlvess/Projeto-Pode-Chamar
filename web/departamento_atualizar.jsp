...
<html>
   <head>
    ...
    <body>
        ...
        <div class="container ">
                        <%
                Departamento d = (Departamento) request.getAttribute("departamentos");
                String mensagem = (String) request.getAttribute("mensagem");
            %>


            <form role="form" class="form-horizontal" action="AlterarDepartamento" method="post">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3" >
                        ...
                        <input type="text" class="form-control" name="dep_nome" placeholder="Nome do Departamento" value = "<% if (d != null)%> <%= d.getDep_nome()%>" />
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class=" control-label">Status:</label>
                        <select class="form-control" name="dep_status">
                            <option value="">Selecione</option>
                            <option value="Ativo" <% if (d.getDep_status().equals("Ativo")) {%> selected="" <% } %>>Ativo</option>
                            <option value="Inativo" <% if (d.getDep_status().equals("Inativo")) {%> selected="" <% } %>>Inativo</option>
                        </select>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label class=" control-label">Descricao: </label>
                        <input type="text" class="form-control" name="dep_descricao" placeholder="Descrição do Departamento" value = "<% if (d != null)%> <%= d.getDep_descricao()%>" />
                        </div>
