...
<html>
    ...
    <body>
        ...
        <div class="container ">
                        <%
               Atividade a = (Atividade) request.getAttribute("atividades");
                String mensagem = (String) request.getAttribute("mensagem");
            %>


            <form role="form" class="form-horizontal" action="AlterarAtividade" method="post">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3" >
                        ...
                        <input type="text" class="form-control" name="ati_nome" placeholder="Nome da Atividade" value = "<% if (a != null)%> <%= a.getAti_nome()%>" />
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class=" control-label">Status:</label>
                        <select class="form-control" name="ati_status">
                            <option value="">Selecione</option>
                            <option value="Ativo" <% if (a.getAti_status().equals("Ativo")) {%> selected="" <% } %>>Ativo</option>
                            <option value="Inativo" <% if (a.getAti_status().equals("Inativo")) {%> selected="" <% } %>>Inativo</option>
                        </select>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label class=" control-label">Descricao: </label>
                        <input type="text" class="form-control" name="ati_descricao" placeholder="Descrição da Atividade" value = "<% if (a != null)%> <%= a.getAti_descricao()%>" />
                        </div>
                        <a href="atividade_atualizar.jsp"></a>
