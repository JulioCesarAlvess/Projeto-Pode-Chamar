 ...
 */
public class ViewSalvaProdutos extends ViewHelper {
    ...
    public EntidadeDominio getEntidade(HttpServletRequest request, HttpServletResponse response) {
        ...
        pro.setPro_fisico(pro.getPro_quantidade());
        pro.setPro_reservado(0);
        pro.setPro_disponivel(pro.getPro_fisico() - pro.getPro_disponivel());
    ...
    public void setView(Resultado resultado, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        request.getRequestDispatcher("/produto_gestao.jsp").forward(request, response);
    }
