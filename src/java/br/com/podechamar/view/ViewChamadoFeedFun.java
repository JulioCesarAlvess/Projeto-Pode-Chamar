 ...
 */
public class ViewChamadoFeedFun extends ViewHelper{
    ...
    public EntidadeDominio getEntidade(HttpServletRequest request, HttpServletResponse response) {
        ...
        String nota_fun = request.getParameter("nota_fun");
        String feedback_fun = request.getParameter("feedback_fun");

        

        cha.setId(Integer.valueOf(id));
        cha.setCha_nota_fun(Integer.valueOf(nota_fun));
        cha.setCha_feedback_fun("Cliente " + u.getUsu_login() + " : " +  feedback_fun);
