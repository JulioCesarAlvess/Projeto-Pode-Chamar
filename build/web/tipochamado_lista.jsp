...
<html>
    ...
    <body>
         <%
            //colher a lista
        List<TipoChamado> tipos = (List<TipoChamado>) request.getAttribute("tipos_chamado");
 ...
 <nav class="navbar navbar-default fixed">
        ...
        <div class="container">
            ...
            <form role="form" class="form-horizontal" action="ListarTipoChamado" >
                ...
                <h2 class="titulo-formulario">Lista de Tipos de Chamado <a href="/podechamar_v1/tipochamado_gestao.jsp" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></a></h2>
                    ...
                    <table class="table table-hover table-condensed" style="width: 700px;">
                        ...
                        <tbody>
                           <%
                            ...
                            <tr>
                               <td> <%= t.getTch_nome()%> </td>
                               <td> <%= Converter.criaHora(t.getTch_normal()) %> </td>
                               <td> <%= Converter.criaHora(t.getTch_urgente())  %> </td>
                               <td> <%= Converter.criaHora(t.getTch_critico()) %> </td>
                               <td> <%= t.getTch_status()%> </td>
                               
                                <td><a href="/podechamar_v1/AlterarTipoChamado?btnOperacao=BUSCAR&id=<%= t.getId()%> " class="btn btn-default" > <i class="glyphicon glyphicon-pencil"></i> </a> <td>
                                    <%
                                       if (!t.getTch_status().equals("Inativo")) {
                                    %>
                                <td><a href="/podechamar_v1/ListarTipoChamado?btnOperacao=EXCLUIR&id=<%= t.getId()%> " class="btn btn-default" > Inativar</a> <td>
                                    <%
                                       }
                                    %>
                            </tr>
