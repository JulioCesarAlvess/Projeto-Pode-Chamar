...
<html>
    <head>
        ...
        <title>Pode Chamar - Lista de Funcionários</title>
    </head>
    <body>
         <%
            //colher a lista
 ...
 <nav class="navbar navbar-default fixed">
        ...
        <div class="container">
            ...
            <form role="form" class="form-horizontal" action="ListarFuncionario" >
                ...
                <h2 class="titulo-formulario">Lista de Funcionarios <a href="/podechamar_v1/SalvarFuncionario" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></a></h2>
                        ...
                        <tbody>
                           <%
                            ...
                            <tr>
                               <td> <%= f.getFun_nome() %> </td>
                               <td> <%= f.getFun_nf() %> </td>
                               <td> <%= f.getFun_email() %> </td>
                               <td> <%= f.getFun_telefone() %> </td>
                               <td> <%= f.getFun_nivel() %> </td>
                               <td> <%= f.getFun_status() %> </td>
                              
                                <td><a href="/podechamar_v1/AlterarFuncionario?btnOperacao=BUSCAR&id=<%= f.getId()%> " class="btn btn-default" > <i class="glyphicon glyphicon-pencil"></i> </a> <td>
                                    <%
                                       if (!f.getFun_status().equals("Inativo")) {
                                    %>
                                <td><a href="/podechamar_v1/ListarFuncionario?btnOperacao=EXCLUIR&id=<%= f.getId()%> " class="btn btn-default" > Inativar</a> <td>
                                    <%
                                       }
                                    %>
                            </tr>
