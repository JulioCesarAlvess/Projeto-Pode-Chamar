...
<html>
    ...
    <body>
        <%
            ...
            List<Linha> linhas = Grafico.ChamadosPorTipos(chamados, tipos, ano);
        ...
        <div class="container">
            ...
            <form name="formFIltro" action="relatorioPorTipos.jsp" >
                </br>Filtros:
                <div class="row">
            ...
            <script type="text/javascript">
                ...
                title: {
                text: 'Chamados por Tipos no ano de <%=ano%>'
                },
                        subtitle: {
