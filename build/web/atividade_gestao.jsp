...
<html>
    ...
    <body>
        ...
        <div class="container ">
            ...
            <form role="form" class="form-horizontal" action="SalvarAtividade" method="post">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3" >
                        ...
                        <input type="text" class="form-control" name="ati_nome" placeholder="Nome da Atividade" />
                    </div>
                    <div class="col-md-6 mb-3" >
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="ati_descricao" placeholder="Descrição da Atividade" />
                        </div>
